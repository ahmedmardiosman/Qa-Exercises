...
public class Runner {
	...
	public static void main(String[] args) {
        ...
        System.out.println("There are monsters appoaching and they want to eat you!! \n You need to get out of there!! \n There is a safe area close by. Hurry !! \n");
	...
	public static void coordinatesOfCharecter() {
		...
		System.out.println("Which direction would you like to travel? (Please Choose) \n1: North  \n2: East \n3: South \n4: West ");
		...
		case 1:
			...
			System.out.println("Your New Coordinates are: ( " + direction.getxPosition() + " , " + direction.getyPosition() +" )");
